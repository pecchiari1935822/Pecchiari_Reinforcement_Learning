...
def _plot_results(cb: BladeCallback, save_path="plot_results.png", training_time=None):
...
def _plot_training_metrics_actor(cb: BladeCallback, save_path="plot_metrics_actor.png"):
...
def _plot_training_metrics_critic(cb: BladeCallback, save_path="plot_metrics_critic.png"):
    if not cb.metrics_episodes:
        print("  Nessuna metrica PPO disponibile (training troppo corto).")
        return
